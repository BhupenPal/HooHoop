var PanoControls = (function () {
  ...
  function init(target, panoViewer, options) {
    ...
    panoViewer.enableSensor().catch(() => {
      Swal.fire({
        ...
        icon: "question",
        text:
          "This website needs a permission to access Device motion & Orientation for the immersive experience.",
      ...
      PanoViewer.isGyroSensorAvailable((available) => {
        if (!available) {
          Swal.fire({
            ...
            icon: "warning",
            text:
              "This website requires a permission for your device motion sensor for the immersive experience.",
            html: `
  ...
  function _initControlHTML(target) {
    ...
    var controls = isMobile()
      ? '\
      <div class="image360_loading"><div id="loader" style="display: block; position:absolute; top:0;left:-5vw; margin: 0 auto;"></div>\
      ...
      : '\
      <div class="image360_loading"><div id="loader" style="display: block; margin:0 auto"></div>\
      <div class="image360_loadingBar">\
      </div></div>\
			<div class="panoviewer-control">\
				<button class="enterfs">' +
